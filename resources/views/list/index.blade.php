...
<div class="container">
    <div class="row">
        <div class="col-md-10 mx-auto">
            ...
            <div class="mb-3">
                <a href="{{ route('list.index', ['type' => 'list', 'prefecture_id' => $prefectureId]) }}" class="btn {{ $type === 'list' ? 'btn-blue' : 'btn-outline-primary' }}">
                    リスト
                </a>
                <a href="{{ route('list.index', ['type' => 'album', 'prefecture_id' => $prefectureId]) }}" class="btn {{ $type === 'album' ? 'btn-pink' : 'btn-outline-danger' }}">
                    アルバム
                </a>
